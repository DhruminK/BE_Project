...
socket.on('token', function () {
	socket.emit('token', _jquery2.default.urlParam('token'));
});

socket.on('message', function (msg) {
	(0, _jquery2.default)('#messages').append((0, _jquery2.default)('<li>').text(msg.content));
});

socket.on('message:noUser', function (msg) {
	(0, _jquery2.default)('#messages').append((0, _jquery2.default)('<li>').text(msg.content));
	noUser = true;
});

socket.on('message:middle', function (msg) {
	middle = true;
	(0, _jquery2.default)('#messages').append((0, _jquery2.default)('<li>').text(msg.content));
});

socket.on('message:question:medium', function (msg) {
	medium_qs = true;
	(0, _jquery2.default)('#messages').append((0, _jquery2.default)('<li>').text(msg.content));
});
socket.on('message:question:hard', function (msg) {
	hard_qs = true;
	(0, _jquery2.default)('#messages').append((0, _jquery2.default)('<li>').text(msg.content));
});

socket.on('message:successful', function (msg) {
	(0, _jquery2.default)('#messages').append((0, _jquery2.default)('<li>').text(msg.content));
	usrSuccessFul = true;
});
...
socket.on('redirect:index', function (msg) {
	setTimeout(function () {
...
socket.on('chat:open', function (msg) {
	(0, _jquery2.default)('#messages').append((0, _jquery2.default)('<li>').text("Opening App :" + msg.content));
});

(0, _jquery2.default)('form').submit(function () {
	var msg = {};
	msg.content = (0, _jquery2.default)('#m').val();
	if (usrSuccessFul) {
...
if (typeof window === 'undefined') {
  try {
    NodeWebSocket = __webpack_require__(57);
  } catch (e) {}
}
